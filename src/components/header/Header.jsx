...
function Header() {
  ...
  // Add this function to render flag SVGs
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden xl:flex items-center space-x-8">
            {/* Tours link with underline effect */}
            ...
            {/* Individual Tours with same effect */}
            ...
            {/* Contact buttons with new design */}
            <div className="flex items-center space-x-4 text-sm">
              ...
              <a 
                href="mailto:asfan.coder@gmail.com?subject=Canaan Travel - Murojaat&body=Assalomu alaykum,%0D%0A%0D%0AMen Canaan Travel sayti orqali murojaat qilmoqdaman.%0D%0A%0D%0AHurmat bilan," 
