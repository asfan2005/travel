  ...
  uz: {
    ...
    sections: {
      section1: {
        ...
        content: [
          "Ushbu shaxsiy ma'lumotlarni qayta ishlash siyosati 21.06.2019 sanasidagi 'Shaxsga doir ma'lumotlar to'g'risida'gi qonun talablariga muvofiq o'rnatilgan va 'Travelcations' MChJ (bundan keyin - Operator) tomonidan shaxsiy ma'lumotlarni qayta ishlash tartibi va shaxsiy ma'lumotlar xavfsizligini ta'minlash choralarini belgilaydi.",
          ...
          "1.2. Ushbu siyosat Operator https://travelcations.uz/ saytini tashrif buyurish uchun olishi mumkin bo'lgan buyurtmalar to'g'risidagi barcha ma'lumotlarga nisbatan qo'llaniladi."
        ]
      },
      section2: {
        ...
        content: [
          ...
          "2.3. Veb-sayt — https://travelcations.uz/ internet tarmog'ida joylashgan grafik va axborot materiallari, shuningdek ularning dasturiy ta'minoti va ma'lumotlar bazalari to'plami.",
          ...
          "2.8. Shaxsiy ma'lumotlar — https://travelcations.uz/ veb-sayti Foydalanuvchisiga bevosita yoki bilvosita tegishli bo'lgan har qanday ma'lumot.",
          ...
          "2.10. Foydalanuvchi — https://travelcations.uz/ veb-saytining har qanday tashrif buyuruvchisi.",
      ...
      section7: {
        ...
        content: [
          ...
          "7.7. Qonun bo'yicha e'lon qilish yoki majburiy oshkor qilish nazarda tutilgan shaxsiy ma'lumotlarni qayta ishlash amalga oshiriladi."
        ]
      },
      section8: {
        ...
        content: [
          ...
          "8.3. Shaxsiy ma'lumotlarda noaniqliklar mavjud bo'lgan taqdirda, Foydalanuvchi ularni Operatorning travelcationsuz@gmail.com elektron pochta manziliga \"Shaxsiy ma'lumotlarni yangilash\" belgisi bilan xabarnoma yuborish orqali mustaqil ravishda yangilashi mumkin.",
          "8.4. Shaxsiy ma'lumotlarni qayta ishlash muddati, agar shartnoma yoki amaldagi qonunchilik bilan boshqa muddat nazarda tutilmagan bo'lsa, shaxsiy ma'lumotlar yig'iladigan maqsadlarga erishish bilan belgilanadi. Foydalanuvchi istalgan vaqtda Operatorning travelcationsuz@gmail.com elektron pochta manziliga \"Shaxsiy ma'lumotlarni qayta ishlashga rozilikni qaytarib olish\" belgisi bilan xabarnoma yuborish orqali shaxsiy ma'lumotlarni qayta ishlashga rozilikni qaytarib olishi mumkin.",
      ...
      section11: {
        ...
        content: {
          uz: [
            "Operator va shaxsiy ma'lumotlarga kirish huquqiga ega boshqa shaxslar,qonunda boshqacha tartib nazarda tutilmagan bo'lsa, shaxsiy ma'lumotlar subyektining roziligisiz uchinchi shaxslarga shaxsiy ma'lumotlarni oshkor qilmaslik va tarqatmaslik majburiyatiga ega."
          ],
          ru: [
      ...
      section12: {
        ...
        content: {
          uz: [
            "12.1. Foydalanuvchi o'z shaxsiy ma'lumotlarini qayta ishlash bo'yicha har qanday savollar bilan travelcationsuz@gmail.com elektron pochta manziliga murojaat qilib, tushuntirish olishi mumkin.",
            ...
            "12.3. Siyosatning amaldagi versiyasi travelcations.uz manzilida Internetda erkin foydalanish uchun joylashtirilgan."
          ],
          ru: [
            "12.1. Пользователь может получить разъяснения по вопросам обработки своих персональных данных, обратившись к Оператору по электронной почте travelcationsuz@gmail.com",
            ...
            "12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу travelcations.uz."
          ],
          en: [
            "12.1. The user can receive clarification on the processing of their personal data by contacting the Operator via email at travelcationsuz@gmail.com.",
            ...
            "12.3. The current version of the Policy is freely available on the Internet at travelcations.uz"
          ]
        }
      }
    }
  ...
  ru: {
    ...
    sections: {
      section1: {
        ...
        content: [
          "Настоящая политика обработки персональных данных составлена в соответствии с требованиями  закона от 21.06.2019 «О персональных данных» и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных ООО «Travelcations» (далее – Оператор).",
          "1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.",
          "1.2. Настоящая политика применяется ко всей инфрмации, которую Оператор может получить о посетителях веб-сайта https://travelcations.uz/"
        ]
      },
      section2: {
        ...
        content: [
          ...
          "2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность на сети интернет по сетевому адресу http://travelcations.uz.",
          ...
          "2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта http://travelcations.uz",
          "2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, - персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных.",
          "2.10. Пользователь – любой посетитель веб-сайта http://travelcations.uz",
          ...
          "Самостоятельно определять состав и перечень мер, необходимых и достаточных для обеспечения выполнения обязанностей, предусмотренных Законом о персональных данных и принятыми в соответствии с ним нормативными правовыми актами, если иное не предусмотрено Законом о персональны данных или другим законами;",
          "3.2. Оператор обязан:",
        ...
        content: [
          {
            ...
            items: [
              "Получать от субъекта персональных данных достоверную информацию и/или документы, содержащие персональные данные;",
              "В случае отзыва субъектом персональных данных согласия на обработку персональных данных, а также в случае поступления запроса о прекращении обработки персональных данных, Оператор вправе продолжить обработку персональные данных без согласия субъекта при наличии оснований, указанных в законе;",
      ...
      section5: {
        ...
        content: [
          ...
          "5.2. Обработка персональных данных ограничивается достижением конкретных, заранее определенных и законух целей. Не допускается обработка персональных данных, несовместимая с целями сбора персональных данных.",
      ...
      section7: {
        ...
        content: [
          ...
          "7.3. Обработка персональных данных необходима для осуществления правосудия, исполнения судебного акта, акта другого органа или должностного лицо, подлежащих исполнению в соответствии с законодательством Республики Узбекистан об исполнительном производстве.",
      ...
      section8: {
        ...
        content: [
          ...
          "8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомления на адрес электронной почты travelcationsuz@gmail.com с пометкой «Актуализация персональных данных».",
          "8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление на адрес электронной почты travelcationsuz@gmail.com с пометкой «Отзыв согласия на обработку персональных данных».",
      ...
      section12: {
        ...
        content: {
          uz: [
            "12.1. Foydalanuvchi o'z shaxsiy ma'lumotlarini qayta ishlash bo'yicha har qanday savollar bilan travelcationsuz@gmail.com elektron pochta manziliga murojaat qilib, tushuntirish olishi mumkin.",
            "12.2. Operator tomonidan shaxsiy ma'lumotlarni qayta ishlash siyosatiga kiritilgan har qanday o'zgarishlar ushbu hujjatda aks ettiriladi. Siyosat yangi versiya bilan almashtirilgunga qadar amal qiladi.",
            "12.3. Siyosatning amaldagi versiyasi http://travelcations.uz manzilida Internetda erkin foydalanish uchun joylashtirilgan."
          ],
          ru: [
            "12.1. Пользователь может получить разъяснения по вопросам обработки своих персональных данных, обратившись к Оператору по электронной почте travelcationsuz@gmail.com.",
            "12.2. Любые изменения в политике обработки персональных данных Оператором будут отражены в данном документе. Политика действует бессрочно до замены ее новой версией.",
            "12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу http://travelcations.uz"
          ],
          en: [
            "12.1. The user can receive clarification on the processing of their personal data by contacting the Operator via email at travelcationsuz@gmail.com.",
            "12.2. Any changes to the personal data processing policy by the Operator will be reflected in this document. The Policy remains valid indefinitely until replaced with a new version.",
            "12.3. The current version of the Policy is freely available on the Internet at http://travelcations.uz"
          ]
        }
      }
    }
  ...
  en: {
    ...
    sections: {
      section1: {
        ...
        content: [
          "This personal data processing policy is dated 21.06.2019 in accordance with the requirements of the Law ' About personal data' and defines the procedure for processing personal data and measures to ensure data security by 'Travelcations' LLC (hereinafter - Operator).",
          ...
          "1.2. This policy applies to all information that the Operator can obtain about visitors to the website https://travelcations.uz/"
        ]
      },
      section2: {
        ...
        content: [
          ...
          "2.3. Website — a set of graphic and information materials, as well as computer programs and databases that ensure their availability on the Internet at the network address https://travelcations.uz/.",
          ...
          "2.8. Personal data – any information relating directly or indirectly to a specific or identifiable User of the website http://travelcations.uz",
          "2.9. Personal data authorized by the personal data subject for distribution - personal data, access to which by an unlimited number of persons is provided by the personal data subject by giving consent to the processing of personal data authorized by the personal data subject for distribution in the manner prescribed by the Law on Personal Data.",
          "2.10. User – any visitor to the website http://travelcations.uz",
          ...
          "Independently determine the content and list of measures necessary and sufficient to ensure the fulfillment of obligations provided for in the Personal Data Act and regulatory legal documents adopted in accordance with it, unless otherwise provided by the Personal Data Act or other laws;",
        ...
        content: [
          {
            ...
            items: [
              "Receive information about the processing of personal data, except for cases provided for by laws. Information is provided to the personal data subject in an understandable form and should not contain personal data of other subjects, except when there are legal grounds for disclosing such data;",
      ...
      section5: {
        ...
        content: [
          ...
          "5.7. Storage of personal data must be carried out in a form that allows identification of the personal data subject for no longer than required by the purposes of personal data processing, unless the storage period is determined by law or contract (where the personal data subject is its party, beneficiary, or guarantor). Processed personal data shall be destroyed or anonymized upon achieving the processing purposes or if the need to achieve these purposes is lost, unless otherwise provided by law."
        ]
      },
      section6: {
      ...
      section7: {
        ...
        content: [
          ...
          "7.7. Processing of personal data is carried out that is subject to publication or mandatory disclosure in accordance with law."
        ]
      },
      section8: {
        ...
        content: [
          ...
          "8.3. In case of inaccuracies in personal data, the User can update them independently by sending a notification to the Operator at travelcationsuz@gmail.com with the mark 'Personal Data Update'.",
          "8.4. The period of personal data processing is determined by achieving the purposes for which personal data was collected, unless another period is provided for by contract or current legislation. The User may at any time withdraw their consent to personal data processing by sending a notification to the Operator at travelcationsuz@gmail.com with the mark 'Withdrawal of Consent to Personal Data Processing'.",
...
function Polise() {
  ...
  return (
    <div style={{marginTop:"80px"}} className="max-w-4xl mx-auto px-4 py-8 text-gray-800">
