  ...
  const dayOneContent = {
    ...
    ru: {
      ...
      timeline: [
        {
          time: "01:05-03:00",
          description: "Прибытие �� еждународный аэропорт Ташкента."
        },
        {
          time: "03:00-04:00",
  ...
  const dayNineContent = {
    ...
    ru: {
      ...
      timeline: [
        ...
        {
          time: "09:00-11:00",
          description: "Осмотр досто��римечательностей Хивы: посещение дворца Нуруллабой в Хиве."
        },
        {
          time: "11:00-12:30",
    ...
    ru: {
      ...
      airportTransfer: {
        ...
        additionalInfo: [
          ...
          "Если ваш рейс задерживается более чем на час или вы не можете найти водителя, пожалуйста, позв��ните по номеру, указанному выше.",
  ...
  const tourPriceDetails = {
    ...
    ru: {
      ...
      priceIncludes: {
        ...
        items: [
          "Проживание в отелях 3* в Т��шкенте, Самарканде, Бухаре и Хиве в номерах SGL/DBL/TWN с завтраком;",
      ...
      priceDoesNotInclude: {
        ...
        items: [
          ...
          "Обед и ужин;",
          "Оплата д��полнительных услуг в отелях;",
    ...
    ru: {
      ...
      countries: {
        ...
        caribbean: [
          ...
          { code: 'VI', name: 'Ви����гинские Острова США' }
        ],
        ...
        dependencies: [
          ...
          { code: 'IO', name: 'Британская тер��итория в И��дийском океане' },
