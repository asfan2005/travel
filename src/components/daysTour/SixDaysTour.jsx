  ...
  const dayOneContent = {
    ...
    ru: {
      ...
      timeline: [
        ...
        {
          time: "09:00-13:00",
          description: "Обзорная экскурсия по городу: Комплекс Хазрат Имам (Мавзолей Кафал Шаши, Медресе Муйи Мубарак, Медресе Барак-хана, гох, Мечеть Хазрат Имам), посещение узбекского махалля, древний город Мингтепа, Малая мечеть."
        },
        {
          time: "13:00-14:00",
          description: "Обед в местном ресторане (Ташкентский пло в Беш Козон - центр плова)."
        },
        {
          time: "14:00-17:00",
  ...
  const dayFiveContent = {
    ...
    ru: {
      ...
      timeline: [
        ...
        {
          time: "09:00-13:00",
          description: "Достопримечательности пригородной зоны: Мемориально-архитектурный комплекс Бахавуддина Нақшбанда (святой филосо 14-го века), Дворец Ситораи Мхи Хоса (летняя резиденция последнего бухарского эмира - 20-й век), Некрополь Чор Бакр (мемориально-архитектурный комплекс 16-го века)."
        },
        {
          time: "13:00-14:00",
    ...
    ru: {
      ...
      airportTransfer: {
        ...
        additionalInfo: [
          ...
          "Если ваш рейс задерживается более чем на час или вы не можете найти водителя, пожалуйста, позвните по номеру, указанному выше.",
  ...
  const tourPriceDetails = {
    ...
    ru: {
      ...
      priceIncludes: {
        ...
        items: [
          "Проживание в отелях 3* в Тшкенте, Самарканде, Бухаре и Хиве в номерах SGL/DBL/TWN с завтраком;",
      ...
      priceDoesNotInclude: {
        ...
        items: [
          ...
          "Обед и ужин;",
          "Оплата дполнительных услуг в отелях;",
